...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ARWorldMapController : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            sessionSubsystem.requestedWorldAlignment = ARWorldAlignment.GravityAndHeading;
        ...
        void Update()
        {
            ...
            //Debug.Log(string.Format("Mapping Status: {0}", sessionSubsystem.worldMappingStatus));
            if (sessionSubsystem.worldMappingStatus != ARWorldMappingStatus.NotAvailable)
            {
                GlobalAR.isWorldLoad = true;
            }
